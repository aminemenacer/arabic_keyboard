...
<!-- taa src file -->
  ...
  <!-- Word boxes -->
  <div class="row text-center container-fluid align-items-center ">
    ...
    <div class="ml-5 div1">
      ...
      <div class="dropdown text-center" style="padding:10px">
        ...
        <div id='colors_1' class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="padding:10px">
          ...
          <a class="dropdown-item" id="white1" href="#">White (Default)</a>
        </div>
    ...
    <div class=" div1">
      ...
      <div class="dropdown text-center" style="padding:10px">
        ...
        <div id='colors_2' class="dropdown-menu" aria-labelledby="dropdownMenuLink">
          ...
          <a class="dropdown-item" id="white2" href="#">White (Default)</a>
    ...
    <div >
      ...
      <div class="dropdown text-center" style="padding:10px">
        ...
        <div id='colors_3' class="dropdown-menu" aria-labelledby="dropdownMenuLink">
          ...
          <a class="dropdown-item" id="white3" href="#">White (Default)</a>
    ...
    <div>
      ...
      <div class="dropdown text-center" style="padding:10px">
        ...
        <div id='colors_4' class="dropdown-menu" aria-labelledby="dropdownMenuLink">
          ...
          <a class="dropdown-item" id="white4" href="#">White (Default)</a>
    ...
    <div>
      ...
      <div class="dropdown text-center" style="padding:10px">
        ...
        <div id='colors_5' class="dropdown-menu" aria-labelledby="dropdownMenuLink">
          ...
          <a class="dropdown-item" id="white5" href="#">White (Default)</a>
    ...
    <div>
      ...
      <div class="dropdown text-center" style="padding:10px">
        ...
        <div id='colors_6' class="dropdown-menu" aria-labelledby="dropdownMenuLink">
          ...
          <a class="dropdown-item" id="white6" href="#">White (Default)</a>
    ...
    <div class="col-3">
      <div class="text-center">
        ...
        <div aria-label="button mt-1" role="group" class="mt-2 "> 
          <a  class="btn btn-info bg-danger text-white" role="button">Preview</a>
          <a class="btn btn-info bg-primary text-white remove"  role="button">Clear</a>
          <button class="btn btn-info bg-success text-white submit" role="button">Submit</button>
    ...
    <div class="container-fluid">
      <div class="row text-center">
        <div class="col-12 text-center">
          <svg id="CanvasFinal" width="80%" class="final_box"></svg> 
        
            <div aria-label="Vertical button group mt-3" role="group" class="btn-group-vertical "> 
              <a class="btn btn-default bg-warning mb-2 remove" type="button">Clear</a> 
...
<script>
  ...
  $('.submit').click(function(){
    $('.div2 svg').clone().appendTo($('.final_box'));
  });
